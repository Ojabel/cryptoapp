      ...
      <section class="section hero" aria-label="hero" data-section>
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 hero-title">Buy & Sell Digital Assets With US</h1>
...
-->
            ...
            <a href="#" class="btn btn-primary" id="link">Explore More</a>
...
<!--
              <li class="section-item">
                <div class="title-wrapper">
                  ...
                  <h3 class="h3 list-title">Buy and sell BTC, ETH, XRP, USD Etc...</h3>
-->
                </div>
<!--
                <p class="item-text">
